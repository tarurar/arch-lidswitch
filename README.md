...
1. **Confirm the pinned release**:
   ...
   The commands below pin `v0.1.4`. Before continuing, confirm that this exact
...
changes intended for the release are committed, publish `v0.1.4` by creating
